...
AS
SELECT crossTrainingID, athleteID, dateofSession, typeOfCrossTraining, totalTimeMinutes, totalDistance
FROM CrossTraining;
...
CREATE TRIGGER emailValidationAthlete
    BEFORE INSERT
    ON Athlete
    FOR EACH ROW
BEGIN
...
CREATE TRIGGER interviewNullOne
    BEFORE INSERT
    ON Interview
    FOR EACH ROW
BEGIN
...
CREATE TRIGGER interviewNullTwo
    BEFORE INSERT
    ON Interview
    FOR EACH ROW
BEGIN
...
CREATE TRIGGER interviewNullThree
    BEFORE INSERT
    ON Interview
    FOR EACH ROW
BEGIN
...
CREATE TRIGGER interviewNullFour
    BEFORE INSERT
    ON Interview
    FOR EACH ROW
BEGIN
...
CREATE TRIGGER interviewNullFive
    BEFORE INSERT
    ON Interview
    FOR EACH ROW
BEGIN
...
CREATE TRIGGER interviewNullSix
    BEFORE INSERT
    ON Interview
    FOR EACH ROW
BEGIN
...
CREATE TRIGGER interviewNullSeven
    BEFORE INSERT
    ON Interview
    FOR EACH ROW
BEGIN
...
CREATE TRIGGER interviewNullEight
    BEFORE INSERT
    ON Interview
    FOR EACH ROW
BEGIN
...
CREATE TRIGGER interviewNullNine
    BEFORE INSERT
    ON Interview
    FOR EACH ROW
BEGIN
...
CREATE TRIGGER interviewNullTen
    BEFORE INSERT
    ON Interview
    FOR EACH ROW
BEGIN
...
CREATE TRIGGER interviewNullEleven
    BEFORE INSERT
    ON Interview
    FOR EACH ROW
BEGIN
...
CREATE TRIGGER interviewNullTwelve
    BEFORE INSERT
    ON Interview
    FOR EACH ROW
BEGIN
...
CREATE TRIGGER interviewNullThirteen
    BEFORE INSERT
    ON Interview
    FOR EACH ROW
BEGIN
...
CREATE TRIGGER interviewNullFourteen
    BEFORE INSERT
    ON Interview
    FOR EACH ROW
BEGIN
...
CREATE TRIGGER interviewNullFifteen
    BEFORE INSERT
    ON Interview
    FOR EACH ROW
BEGIN
...
CREATE TRIGGER interviewNullSixteen
    BEFORE INSERT
    ON Interview
    FOR EACH ROW
BEGIN
...
CREATE TRIGGER interviewNullSeventeen
    BEFORE INSERT
    ON Interview
    FOR EACH ROW
BEGIN
...
CREATE TRIGGER interviewNullEighteen
    BEFORE INSERT
    ON Interview
    FOR EACH ROW
BEGIN
...
CREATE TRIGGER interviewNullNineteen
    BEFORE INSERT
    ON Interview
    FOR EACH ROW
BEGIN
...
CREATE TRIGGER interviewNullTwenty
    BEFORE INSERT
    ON Interview
    FOR EACH ROW
BEGIN
...
CREATE TRIGGER interviewNullTwentyOne
    BEFORE INSERT
    ON Interview
    FOR EACH ROW
BEGIN
...
CREATE TRIGGER interviewNullTwentyTwo
    BEFORE INSERT
    ON Interview
    FOR EACH ROW
BEGIN
...
CREATE TRIGGER interviewNullTwentyThree
    BEFORE INSERT
    ON Interview
    FOR EACH ROW
BEGIN
...
CREATE TRIGGER interviewNullTwentyFour
    BEFORE INSERT
    ON Interview
    FOR EACH ROW
BEGIN
...
CREATE PROCEDURE decrypt_data(IN theAthleteID INT,
                              IN theKey VARCHAR(255))
BEGIN
    SELECT medicalDataID,
           athleteID,
...
DELIMITER //
CREATE
    DEFINER = 'webappuser'@'localhost' PROCEDURE user_cnt()
...
DELIMITER //
CREATE
    DEFINER = 'webappuser'@'localhost' PROCEDURE find_number_applicants()
    SQL SECURITY INVOKER
BEGIN
...
DELIMITER //
CREATE
    DEFINER = 'webappuser'@'localhost' PROCEDURE find_number_coaches()
    SQL SECURITY INVOKER
BEGIN
...
DELIMITER //
CREATE
    DEFINER = 'webappuser'@'localhost' PROCEDURE find_number_athletes()
    SQL SECURITY INVOKER
BEGIN
...
BEGIN
    ...
    FROM Athlete a
             INNER JOIN MorningMonitoring mm ON a.athleteID = mm.athleteID
    WHERE mm.date = curdate()
    ORDER BY a.athleteID asc;
END //
DELIMITER ;
