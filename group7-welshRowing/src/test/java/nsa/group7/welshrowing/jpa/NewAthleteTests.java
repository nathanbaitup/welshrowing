...
public class NewAthleteTests {
    ...
    public void shouldAddAthleteToDB() throws Exception{
        Athlete athlete = athleteRepoJPA.save(new Athlete(1L, null, "nathan", "male", "2001-02-24", false, "test@test.com", "07894561230", " ", "2 test lane" , "cf12 3hh", "cardiff university", null, null, null, null, "Facebook", false," "));
    ...
    public void shouldFindAthleteIDFromName() throws Exception{
        Athlete athlete = athleteRepoJPA.save(new Athlete(2L, null, "test", "male", "2001-02-24", true, "test@test.com",  "07894561230", " ", "2 test lane",  "cf12 3hh", "cardiff university", null, null, null, null, "Facebook", false ,"" ));
